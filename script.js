...
document.getElementById('fishpole').addEventListener('click', function() {
    var seaCreatures = [
        ...
        { name: 'Tilapia', message: 'A primarily vegetarian fish that prefers warm water.', season: 'Fall/Summer', time: '6am-1pm', size: '11-31 inches', leftImageSrc: './image/tilapia_ori.png', rightImageSrc: './image/tilapia.png' },
